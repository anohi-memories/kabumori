...
- control: only `.agent/tasks/CODEX_TASK_2.md` and `.agent/CODEX_REPORT_2.md` are being synchronized to GitHub. TASK is `review_required` / `next_owner: chatgpt`. Formal repo's existing uncommitted changes and all other slots remain untouched.
