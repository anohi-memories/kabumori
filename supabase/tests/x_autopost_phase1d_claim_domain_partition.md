...
| Direct/manual row writers (admin, SQL) | — | not established | not established | 3 | unbound only; bound insert gated, lifecycle v2-only | legacy | admin pages read `scheduled_posts` only |
